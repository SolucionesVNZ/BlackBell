...
@section('content')
    ...
    <div class="banner-principal bdisc">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="../../img/muaythai/ml2.png" alt="karate" class="karate-img"/>
                </div>
                <div class="col-md-6">
                        ...
                        <form method="POST" action="{{route('guardarFormulario')}}">
                            ...
                            <div class="form-group text-center">
                                <?php $url = $_SERVER["REQUEST_URI"]?>
                                    <input type="hidden" name="disciplina"  value="Muay Thai Intermedio">
    ...
    <div class="dirigido">
        <div class="container">
            ...
            <p class="text-dirigido">Este curso va dirigido  a todas las personas que tengan un conocimiento intermedio
                en el deporte <b>(Muay Thai)</b> y quieran continuar aprendiendo nuevas técnicas. <br>Practicando esta disciplina de
    ...
    <div class="banner-disciplina bdisc">
        <div class="container">
            ...
            <?php
            $products = \App\Models\Producto::where([['fk_disciplina', 2],['fk_nivel', 2]])->get();
            ?>
